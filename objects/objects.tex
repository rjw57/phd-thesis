...
represented by some element $M$ if all $X$ which satisfy
\[
X \wedge M = 0
\]
lie on the object and all point on the object satisfy that relation. We
term this an \emph{incidence relation}.
