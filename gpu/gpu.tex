...
properties but it is intended illustration of the power of GA algorithms when
...
future focussed research into the hardware acceleration of GA-based algorithms.
