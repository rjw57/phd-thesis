...
will reflect a different geometry.
...
in figure \ref{fig:circlelimit}. Where moving, for example, one across
and two up does not lead to the same position as moving two up and then
one across. It is therefore geometrically clear why,
...
the co-variant rotor structure to generalise the result to
...
reflection in $e$ is now a fully co-variant operation.
...
transforming, which is what is required of a co-variant
...
the power of the co-variant method for hyperbolic geometry.
...
\end{equation}
%
Everything on the right hand side is co-variant, and the separation between
...
\end{equation}
%
which is a fully co-variant expression.
...
co-variant form we require for generalisation. Note
%
%
\begin{equation}
