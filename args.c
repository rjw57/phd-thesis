/* args.c - Parse command-line argument for svg2pdf using getopt
 *
...
static const char ARGS_PROGRAM_VERSION[] = "0.1.3";
static const char ARGS_PROGRAM_DESCRIPTION[] = "svg2pdf - Render an SVG image to a PNG image";
